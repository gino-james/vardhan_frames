...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Vardhan's Viewfinder — fashion, product & street photography. Capturing stories beyond vision." },
      { name: "author", content: "Vardhan's Viewfinder" },
